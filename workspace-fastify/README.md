...
Next.js 채팅 사이드바는 hydrate된 대화 이력을 제목/최근 메시지 기준으로 검색할 수 있고, 오늘/어제/지난 7일/지난 30일/월별 그룹으로 묶어 표시합니다. 삭제 중에는 해당 항목에 진행 상태를 표시하고, hydrate 실패 시에는 로컬 optimistic 이력을 사용 중임을 footer에서 안내합니다.
